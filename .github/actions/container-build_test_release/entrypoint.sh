...
if [ "${USE_CLANG}" = true ]; then
   docker build -t ghcr.io/nwchemex-project/release_utilities:clang-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_utilities:clang-latest
else
   docker build -t ghcr.io/nwchemex-project/release_utilities:gcc-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_utilities:gcc-latest
fi
