...
struct BidirectionalIteratorBase
    : public InputIteratorBase<ParentType, ValueType, SizeType,
                               DifferenceType> {
  ...
  operator=(const BidirectionalIteratorBase & /*rhs*/) = default;
  ...
  /// Trivial move assignment
  BidirectionalIteratorBase &
  operator=(BidirectionalIteratorBase && /*rhs*/) noexcept = default;
...
struct RandomAccessIteratorBase
  ...
  operator=(const RandomAccessIteratorBase &) = default;
  ...
  /// Trivial move assignment
  RandomAccessIteratorBase &
  operator=(RandomAccessIteratorBase &&) noexcept = default;
