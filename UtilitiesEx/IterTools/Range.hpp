#pragma once
#include "UtilitiesEx/Containers/RangeContainer.hpp"
...
public:
  ...
  /**
   * @brief Assigns a deep copy of another RangeItr to the current instance.
   * @param[in] rhs The RangeItr instance to take ownership of.  After the call
  ...
  RangeItr(element_type start, element_type stop, difference_type increment)
      : start_(start), stop_(stop), increment_(increment), value_(start_) {}
 ...
 */
template <typename element_type> auto Range(element_type stop) {
