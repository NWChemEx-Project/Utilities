...
struct BidirectionalIterator:public
                             BidirectionalIteratorBase<BidirectionalIterator,int>
{
    int value_=0;
...
struct RandomAccessIterator:public
                             RandomAccessIteratorBase<RandomAccessIterator,int>
{
    int value_=0;
